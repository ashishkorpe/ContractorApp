...
// app.delete('/cont/:id',function(req,res){
// 	var id = req.params.id;
// 	console.log(id);
// 	db.cont.remove({_id:mongojs.ObjectId(id)},function(err,doc){
// 		res.json(doc);
// 	});
// });

// app.get('/cont/:id',function(req,res){
// 	var id = req.params.id;
// 	console.log(id);
// 	db.cont.findOne({_id:mongojs.ObjectId(id)},function(err,doc){
// 		res.json(doc);
// 	});
// });
